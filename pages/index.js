...
function extra (index){
  ...
  return (
    <div>
      ...
      <div><Image src= {perfix + addgif} className={homeStyle.ad}/></div>
      ...
      <div className={homeStyle.newsbox1} onClick={() => setmore(()=> extra(index))}><center><div className={homeStyle.news}><Image src={perfix + imgholder} width="100%"/></div></center><p className={homeStyle.title}>{news.title.substring(0, 50)}</p></div>
      ...
      <div style={{position:"fixed" , height:"100%" , width:"100%" , background:"rgba(195, 121, 255, 0.645)", top:"0" , left:"0"}} onClick={() => setmore(!more)} className={homeStyle.boxanime}>
       ...
       <div className={homeStyle.infobox1}><Image src={perfix + imgholder}/><div style={{marginTop:'1rem'}}><span style={{padding:"1rem",textShadow:"0 1px 1px #f0f"}}>published at:</span><span style={{textShadow:"0 1px 1px black"}}>{news[numindex].published}</span></div><div><span style={{padding:"1rem",textShadow:"0 1px 1px #f0f"}}>Author:</span><span style={{textShadow:"0 1px 1px black"}}></span></div></div>
